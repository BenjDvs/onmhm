...
// CANVAS 
//SEARCH FOR:
//txt.color =  Change to your desired text color.
//Example = timerTxt.color, resultTitleTxt.color, resultScoreTxt.color, levelTxt.color, levelTxt.color.
//run: //increase speed
//Initialize
...
function buildGameCanvas(){
	...
	numberTxt.color = "yellow"; // Change to your desired text color #cc16b1
	...
	levelTxt.color = "blue";
// Change to your desired text color; former#fff.
	...
	timerTxt.color = "orange"; // Change to your desired text color #000
	timerTxt.textAlign = "center";
	timerTxt.textBaseline='alphabetic';
	//timerTxt.text = '00:00';
timerTxt.text = '02:00'; 
// Initialize display to 2 minutes
	timerTxt.y = 0+10;
// timerTxt.y = 0 + 3; update later

// Initialize timer variables
var initialTime = 120; // 2 minutes in seconds
...
function updateTimer() {
    if (currentTime > 0) {
        ...
        timerTxt.text = minutes + ":" + (seconds < 10 ? "0" : "") + seconds;
    } else {
        // Timer reached zero, handle end of timer
    }
}
...
//END
	...
	var _frame = {"regX":_frameW/2, "regY":_frameH/2, "width": _frameW, "height": _frameH, "count": 5};
	var _animations = {
						red:{frames: [0], speed:.10},
						green:{frames: [1], speed:.10}
					};
...
for (var n = 0; n < players_arr.length; n++) {
    ...
    var _animations = {
        idle: { frames: [0, 1], speed: .3 },
        run: { frames: [2, 3], speed: .6 }, // Increased speed
        dead: { frames: [4, 5, 6], speed: .3 },
        pull: { frames: [7, 8], speed: .3 },
        front: { frames: [9, 10], speed: .3 },
        frontrun: { frames: [11, 12], speed: .6 }, // Increased speed
...
//ENDS HERE
	...
	resultTitleTxt.color = "red"; // Change to your desired text color. #D6D6D6
	...
	resultScoreTxt.color = "purple"; //#fff
	...
	confirmMessageTxt.color = "#000"; //#fff
